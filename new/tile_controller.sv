...
// adjust to accomodate the person_detection PW and DW layer switching
...
module tile_controller # (
    ...
    // New signals for switching between DW and PW layer types:
    input logic i_layer_type, // 0 = depthwise, 1 = pointwise
    input logic [ADDR_WIDTH-1:0] i_Cin, // used in FIFO POP
